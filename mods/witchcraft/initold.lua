...
witchcraft.pot = {
	...
	{"orange", "redbrown", "witchcraft:bottle_slime", "yellow", "farming_plus:orange_item", "green", "yllwgrn"},
	{"yellow", "yllwgrn", "tnt:tnt", "cyan2", "mobs:minotaur_eye", "darkpurple", "redbrown"},
...
minetest.register_abm({
	nodenames = {"witchcraft:pot_water", "witchcraft:pot_redbrown", "witchcraft:pot_blue2", "witchcraft:pot_cyan", "witchcraft:pot_green", "witchcraft:pot_green2", "witchcraft:pot_aqua", "witchcraft:pot_yellow", "witchcraft:pot_yllwgrn", "witchcraft:pot_red", "witchcraft:pot_magenta", "witchcraft:pot_brown", "witchcraft:pot_cyan2"},
	interval = 0.5,
	chance = 1,
...
--		exertion.getPlayerState(user).state.speed_mod = 2.0
--		local effect = user:set_physics_override({
--
--		speed = 2.0 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
...
--			user:set_breath(11)
--			exertion.getPlayerState(user).state.speed_mod = 1.0 
--			local effect = user:set_physics_override({
--
--		speed = 1.0 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.0 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
--		gravity = 1, -- multiplier to default value
--		sneak = true, -- whether player can sneak
--		sneak_glitch = false, -- whether player can use the sneak glitch 
--
...
--		local player = user:get_player_name()
--		local breath_change = user:set_breath(5)
--		exertion.getPlayerState(user).state.speed_mod = 2.5
--		local effect = user:set_physics_override({
--
--		speed = 2.5 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.0 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
--		gravity = 1, -- multiplier to default value
--		sneak = true, -- whether player can sneak
--		sneak_glitch = false, -- whether player can use the sneak glitch 
--
--		})
--		local reset = minetest.after(30, function()
--			user:set_breath(11)
--			exertion.getPlayerState(user).state.speed_mod = 1.0
--			local effect = user:set_physics_override({
--
...
--minetest.register_node("witchcraft:potion_cyan2", {
...
--		local player = user:get_player_name()
--		local breath_change = user:set_breath(5)
--		exertion.getPlayerState(user).state.jump_mod = 1.5
--		local effect = user:set_physics_override({
--
--		speed = 1.0 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.5 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
...
--		local reset = minetest.after(10, function()
--			user:set_breath(11)
--			exertion.getPlayerState(user).state.jump_mod = 1.0
--			local effect = user:set_physics_override({
--
--		speed = 1.0 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.0 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
...
--		local player = user:get_player_name()
--		local breath_change = user:set_breath(5)
--		exertion.getPlayerState(user).state.speed_mod = 0.5
--		local effect = user:set_physics_override({
--
--		speed = 0.5 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.0 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
--		gravity = 1.2, -- multiplier to default value
--		sneak = true, -- whether player can sneak
--		sneak_glitch = false, -- whether player can use the sneak glitch 
--
--		})
...
--		local player = user:get_player_name()
--		local breath_change = user:set_breath(5)
--		exertion.getPlayerState(user).state.speed_mod = 0.4
--		local effect = user:set_physics_override({
--
--		speed = 0.4 * exertion.getPlayerState(user).state.speed_armor, -- multiplier to default value
--		jump = 1.0 * exertion.getPlayerState(user).state.jump_armor, -- multiplier to default value
--		gravity = 1.2, -- multiplier to default value
--		sneak = true, -- whether player can sneak
--		sneak_glitch = false, -- whether player can use the sneak glitch 
...
--		local mypos = user:getpos();
--    mypos.y = mypos.y + 2
--    print(minetest.get_node(mypos).name)
--	if breath <= 10 then
--		exertion.getPlayerState(user).state.speed_mod = 3.0
