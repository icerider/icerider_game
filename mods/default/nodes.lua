...
-- Liquids
--
minetest.register_node("default:water_source_2", {
	...
	liquid_range = 2,
	liquid_alternative_flowing = "default:water_flowing_2",
	liquid_alternative_source = "default:water_source_2",
	liquid_viscosity = 1,
	post_effect_color = {a = 103, r = 30, g = 60, b = 90},
	groups = {water = 3, liquid = 3, puts_out_fire = 1},
})

minetest.register_node("default:water_flowing_2", {
