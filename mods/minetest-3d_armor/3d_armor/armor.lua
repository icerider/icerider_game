...
armor.set_player_armor = function(self, player)
	...
	player_state = exertion.getPlayerState(player)
	if player_state then
		player_state.state.jump_armor = physics_o.jump;
		player_state.state.speed_armor = physics_o.speed;
		speed_mod = player_state.state.speed_mod
		jump_mod = player_state.state.jump_mod
	else
		speed_mod = 1.0
		jump_mod = 1.0
	end
	...
	physics_o.speed = physics_o.speed * speed_mod
	physics_o.jump = physics_o.jump * jump_mod
