...
minetest.register_alias("technic_aluminum:sapphire","glooptest:sapphire_gem")
minetest.register_alias("technic_aluminum:stone_with_sapphire","glooptest:mineral_sapphire")
minetest.register_alias("technic_aluminum:sapphire_block","glooptest:sapphireblock")
