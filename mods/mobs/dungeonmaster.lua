...
mobs:spawn_specific("mobs:dungeon_master", {"default:stone", "default:sandstone", "nether:netherrack"}, {"air"}, -1, 20, 30, 10000, 1, -31000, -250, false, false)
-- register spawn egg
...
mobs:register_arrow("mobs:fireball", {
	...
	hit_player = function(self, player)
		player:punch(self.object, 1.0, {		-- Mettre à 2.5 aussi ?
			...
			damage_groups = {fleshy = 10},		-- Modif MFF
		}, nil)
	end,
