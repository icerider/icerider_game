if minetest.get_modpath("technic") then
	local stats = {
		aluminum = { name="Aluminum", armor=2.0, heal=15, use=200 },
	}
	local mats = {
    ...
    if false then
		stats.aluminum_copper = { name="2xxx Aluminum", armor=2.2, heal=15, use=100 }
		mats.aluminum_copper = "technic_aluminum:aluminum_copper_ingot"
		stats.aluminum_zinc = { name="7xxx Aluminum", armor=2.3, heal=15, use=75 }
