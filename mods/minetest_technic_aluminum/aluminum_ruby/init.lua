...
minetest.register_alias("technic_aluminum:ruby","glooptest:ruby_gem")
minetest.register_alias("technic_aluminum:stone_with_rubies","glooptest:mineral_ruby")
minetest.register_alias("technic_aluminum:ruby_block","glooptest:rubyblock")
